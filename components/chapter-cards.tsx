    ...
    <section className="bg-black py-16">
      <div className="container mx-auto px-4">
        <div className="mb-12 text-center">
          <h2 className="mb-4 text-3xl font-bold text-white md:text-4xl">Our Chapters</h2>
          <p className="mx-auto max-w-2xl text-lg text-gray-300">
            Join one of our regional chapters and connect with Lincoln Continental enthusiasts in your area
          </p>
        </div>
          ...
          {chapters.map((chapter) => (
            <Link key={chapter.id} href={`/chapters/${chapter.id}`} className="group">
              <div className="overflow-hidden rounded-lg border border-gray-800 bg-gray-900 transition-all duration-300 hover:border-gray-600 hover:shadow-lg">
                ...
                <div className="p-6">
                  <h4 className="mb-2 text-xl font-bold text-white">{chapter.region}</h4>
